document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            "about-text-1": "Soy estudiante de Ingeniería Informática con un interés en el desarrollo Front-End. Me gusta crear interfaces que no solo se vean bien, sino que también sean fáciles de usar.",
            "about-text-2": "Tengo conocimientos prácticos en HTML5, CSS3 y JavaScript, y he trabajado en proyectos personales donde aplico lógica y consumo de APIs. Me siento cómodo utilizando Git para el control de versiones y siempre busco mejorar mis habilidades técnicas para aportar soluciones útiles. Cuento con nivel de inglés B2 certificado.",
            ...
            "proj2-title": "Catálogo de Juegos",
            "proj2-desc": "Aplicacion web con filtrado dinámico y persistencia de datos mediante LocalStorage, permitiendo mantener preferencias del usuario incluso después de cerrar la sesión.",
        ...
        en: {
            ...
            "about-text-1": "I am a Computer Engineering student with an interest in Front-End development. I enjoy creating interfaces that not only look good but are also easy to use.",
            "about-text-2": "I have practical knowledge of HTML5, CSS3, and JavaScript, and I have worked on personal projects applying logic and consuming APIs. I am comfortable using Git for version control and always seek to improve my technical skills to provide useful solutions. I hold a certified B2 level of English.",
            ...
            "proj2-title": "Games Catalog",
            "proj2-desc": "Web application with dynamic filtering and data persistence via LocalStorage, allowing user preferences to be maintained even after session close.",
