document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            "exp1-role": "Practicante de Soporte y Administración de Sistemas",
            "exp1-company": "Tecnológico de Estudios Superiores de Ecatepec — Centro de Computación y Telemática",
            "exp1-date": "Ene. 2026 – Jul. 2026 · 7 meses",
            "exp1-task1": "Administración de usuarios e identidades en Microsoft 365 y Microsoft Entra ID (Azure AD).",
            "exp1-task2": "Gestión de permisos, políticas de acceso y credenciales institucionales.",
            "exp1-task3": "Soporte técnico a usuarios institucionales y resolución de incidentes de autenticación.",
        ...
        en: {
            ...
            "exp1-role": "Systems Administration & IT Support Intern",
            "exp1-company": "Tecnológico de Estudios Superiores de Ecatepec — Computing & Telematics Center",
            "exp1-date": "Jan 2026 – Jul 2026 · 7 mos",
            "exp1-task1": "User and identity administration in Microsoft 365 and Microsoft Entra ID (Azure AD).",
            "exp1-task2": "Management of access permissions, security policies, and institutional credentials.",
            "exp1-task3": "Technical support for institutional users and resolution of authentication incidents.",
