document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            "about-text-1": "Soy egresado de Ingeniería Informática con un gran interés en el desarrollo Front-End. Me gusta crear interfaces que no solo se vean bien, sino que también sean fáciles de usar.",
        ...
        en: {
            ...
            "about-text-1": "I am a Computer Engineering graduate with a strong interest in Front-End development. I enjoy creating interfaces that not only look good but are also easy to use.",
